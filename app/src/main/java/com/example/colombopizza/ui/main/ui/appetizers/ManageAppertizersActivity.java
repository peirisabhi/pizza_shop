...
public class ManageAppertizersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_appertizers);
...
//                    image.setImageBitmap(bitmap);
    ...
    public void insert_product(View view) {
        ...
        if(idString.equals("") || idString == null){
            ...
            product.setCategory("Appertizers");
    ...
    public void viewAllProducts(View view) {
        Intent intent = new Intent(ManageAppertizersActivity.this, Menu2.class);
