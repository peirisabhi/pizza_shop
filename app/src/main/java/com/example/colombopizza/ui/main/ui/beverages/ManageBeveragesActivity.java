...
public class ManageBeveragesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_beverages);
...
//                    image.setImageBitmap(bitmap);
    ...
    public void viewAllProducts(View view) {
        Intent intent = new Intent(ManageBeveragesActivity.this, Menu2.class);
