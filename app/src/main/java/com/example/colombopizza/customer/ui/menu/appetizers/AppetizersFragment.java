package com.example.colombopizza.customer.ui.menu.appetizers;
...
public class AppetizersFragment extends Fragment {
    ...
    public AppetizersFragment(MenuFragment menuFragment){
    ...
    private void loadProducts(){
        ArrayList<Product> products = db.getProductByCategory("Appertizers");
